			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					...
					<div class="navbar nav_title" style="border: 0;">
						<a href="index.php" class="site_title"><i class="fa fa-inbox"></i> <span>Wardrobe</span></a>
					</div>
					...
					<div class="profile">
						<div class="profile_pic">
							<img src="images/C360_2015-09-01-13-30-59-467_SQUARE_128.jpg" alt="..." class="img-circle profile_img">
						</div>
						<div class="profile_info">
							<span>Welcome,</span>
							<h2>Azalea Fisitania</h2>
                            <br />
						</div>
					</div>
					<!-- /menu prile quick info -->
					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						...
						<div class="menu_section">
							<h3>Extra</h3>
							<ul class="nav side-menu">
								<li><a><i class="fa fa-book"></i> Vocabulary <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
										<li><a>Tops</a>
										</li>
